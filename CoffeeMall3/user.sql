...
ALTER TABLE tbl_user MODIFY uName VARCHAR2(15);
ALTER TABLE tbl_user MODIFY uPassword VARCHAR2(110);
ALTER TABLE tbl_user MODIFY uBirth DATE;
ALTER TABLE tbl_user MODIFY uPostnumber VARCHAR2(10);
ALTER TABLE tbl_user MODIFY uAddress VARCHAR2(200);
ALTER TABLE tbl_user MODIFY udetailAddress VARCHAR2(100);
ALTER TABLE tbl_user MODIFY uPhone VARCHAR2(15);
