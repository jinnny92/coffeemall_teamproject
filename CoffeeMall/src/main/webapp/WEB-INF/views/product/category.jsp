...
@import
	url(//fonts.googleapis.com/css?family=Abril+Fatface|Droid+Serif:400,700,400italic,700italic)
	;
			...
			<div class="col-sm">
				<div class="blog-card1 spring-fever col-sm">
					<div class="title-content1">
						<h3>
							<a href="/product/list/원두">Bean</a>
						</h3>
						<div class="intro1">
							원두<a href="/product/list/원두"></a>
						</div>
					</div>
					<div class="card-info1">

						<a href="/product/list/원두">Shop<span
							class="licon icon-arr icon-black"></span></a>
					</div>
			...
			<div class="col-sm">
				<div class="blog-card2 spring-fever col-sm">
					<div class="title-content2">
						<h3>
							<a href="/product/list/콜드브루">Cold Brew</a>
						</h3>
						<div class="intro2">
							콜드브루<a href="/product/list/콜드브루"></a>
						</div>
					</div>
					<div class="card-info2">

						<a href="/product/list/콜드브루">Shop<span
							class="licon icon-arr icon-black"></span></a>
					</div>
			...
			<div class="col-sm">
				<div class="blog-card3 spring-fever col-sm">
					<div class="title-content3">
						<h3>
							<a href="/product/list/핸드드립">Hand Drip</a>
						</h3>
						<div class="intro3">
							핸드드립<a href="/product/list/핸드드립"></a>
						</div>
					</div>
					<div class="card-info3">

						<a href="/product/list/핸드드립">Shop<span
							class="licon icon-arr icon-black"></span></a>
					</div>
